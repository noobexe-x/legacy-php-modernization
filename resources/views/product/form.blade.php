 ...
 <div class="modal-body">
     <form method="POST" id="submitForm" enctype="multipart/form-data" action="{{ url('product/submit') }}">
         ...
         <div class="row">
             <div class="mb-3">
                 ...
                 <div style="position: relative; width: 40%;">
                     <i class="bi bi-x-circle fs-3 m-0 p-0 text-danger"
                         style="position: absolute; right: 5px;top: -2px; cursor: pointer;" onclick="removeProfile()"></i>
                     <img id="img_preview"
             ...
             <div class="required mb-3">
                 <label for="product_category_id" class="form-label">カテゴリ</label>
